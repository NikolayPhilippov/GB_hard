...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_part2_2eproto[3];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_part2_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_part2_2eproto = nullptr;

const uint32_t TableStruct_part2_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  ...
  PROTOBUF_FIELD_OFFSET(::Student, scores_),
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::FullName)},
  { 9, -1, -1, sizeof(::Student)},
  { 18, -1, -1, sizeof(::StudentsGroup)},
};
...
const char descriptor_table_protodef_part2_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\013part2.proto\"=\n\010FullName\022\014\n\004name\030\001 \001(\t\022"
  "\017\n\007surname\030\002 \001(\t\022\022\n\npatronymic\030\003 \001(\t\"M\n\007"
  "Student\022\034\n\tfull_name\030\001 \001(\0132\t.FullName\022\016\n"
  "\006scores\030\002 \003(\005\022\024\n\014averageScore\030\003 \001(\001\"+\n\rS"
  "tudentsGroup\022\032\n\010students\030\001 \001(\0132\010.Student"
  "b\006proto3"
  ;
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_part2_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_part2_2eproto = {
  false, false, 208, descriptor_table_protodef_part2_2eproto, "part2.proto", 
  &descriptor_table_part2_2eproto_once, nullptr, 0, 3,
  schemas, file_default_instances, TableStruct_part2_2eproto::offsets,
  file_level_metadata_part2_2eproto, file_level_enum_descriptors_part2_2eproto, file_level_service_descriptors_part2_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_part2_2eproto_getter() {
  return &descriptor_table_part2_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_part2_2eproto(&descriptor_table_part2_2eproto);
...
::PROTOBUF_NAMESPACE_ID::Metadata FullName::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_part2_2eproto_getter, &descriptor_table_part2_2eproto_once,
      file_level_metadata_part2_2eproto[0]);
}
...
class Student::_Internal {
 public:
  static const ::FullName& full_name(const Student* msg);
};
...
Student::Student(const Student& from)
  ...
  if (from._internal_has_full_name()) {
    full_name_ = new ::FullName(*from.full_name_);
  } else {
    full_name_ = nullptr;
  }
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    ...
    reinterpret_cast<char*>(&full_name_)) + sizeof(averagescore_));
}
...
// @@protoc_insertion_point(class_specific_merge_from_start:Student)
  ...
  if (from._internal_has_full_name()) {
    _internal_mutable_full_name()->::FullName::MergeFrom(from._internal_full_name());
  }
  static_assert(sizeof(uint64_t) == sizeof(double), "Code assumes uint64_t and double are the same size.");
...
::PROTOBUF_NAMESPACE_ID::Metadata Student::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_part2_2eproto_getter, &descriptor_table_part2_2eproto_once,
      file_level_metadata_part2_2eproto[1]);
}
...
class StudentsGroup::_Internal {
 public:
  static const ::Student& students(const StudentsGroup* msg);
};

const ::Student&
StudentsGroup::_Internal::students(const StudentsGroup* msg) {
  return *msg->students_;
}
...
StudentsGroup::StudentsGroup(const StudentsGroup& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  if (from._internal_has_students()) {
    students_ = new ::Student(*from.students_);
  } else {
    students_ = nullptr;
  }
...
inline void StudentsGroup::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  if (this != internal_default_instance()) delete students_;
}
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ptr = ctx->ParseMessage(_internal_mutable_students(), ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* StudentsGroup::_InternalSerialize(
  ...
  // .Student students = 1;
  if (this->_internal_has_students()) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(
        1, _Internal::students(this), target, stream);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:StudentsGroup)
  ...
  if (from._internal_has_students()) {
    _internal_mutable_students()->::Student::MergeFrom(from._internal_students());
  }
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
...
void StudentsGroup::InternalSwap(StudentsGroup* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  swap(students_, other->students_);
}

::PROTOBUF_NAMESPACE_ID::Metadata StudentsGroup::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_part2_2eproto_getter, &descriptor_table_part2_2eproto_once,
      file_level_metadata_part2_2eproto[2]);
}
