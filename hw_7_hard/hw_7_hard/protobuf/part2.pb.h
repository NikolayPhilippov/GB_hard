...
#ifndef GOOGLE_PROTOBUF_INCLUDED_part2_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_part2_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_part2_2eproto
...
struct TableStruct_part2_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_part2_2eproto;
class FullName;
...
class FullName final :
 ...
 private:
  ...
  friend struct ::TableStruct_part2_2eproto;
};
// -------------------------------------------------------------------
...
class Student final :
 ...
 public:
  ...
  const ::FullName& full_name() const;
  PROTOBUF_NODISCARD ::FullName* release_full_name();
  ::FullName* mutable_full_name();
  void set_allocated_full_name(::FullName* full_name);
  private:
  const ::FullName& _internal_full_name() const;
  ::FullName* _internal_mutable_full_name();
  public:
  void unsafe_arena_set_allocated_full_name(
      ::FullName* full_name);
  ::FullName* unsafe_arena_release_full_name();
...
class StudentsGroup final :
 ...
 public:
  ...
  private:
  bool _internal_has_students() const;
  public:
  void clear_students();
  const ::Student& students() const;
  PROTOBUF_NODISCARD ::Student* release_students();
  ::Student* mutable_students();
  void set_allocated_students(::Student* students);
  private:
  const ::Student& _internal_students() const;
  ::Student* _internal_mutable_students();
  public:
  void unsafe_arena_set_allocated_students(
      ::Student* students);
  ::Student* unsafe_arena_release_students();
...
inline const ::FullName& Student::_internal_full_name() const {
  const ::FullName* p = full_name_;
  return p != nullptr ? *p : reinterpret_cast<const ::FullName&>(
      ::_FullName_default_instance_);
}
inline const ::FullName& Student::full_name() const {
  // @@protoc_insertion_point(field_get:Student.full_name)
...
inline void Student::unsafe_arena_set_allocated_full_name(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:Student.full_name)
}
inline ::FullName* Student::release_full_name() {
  
  ::FullName* temp = full_name_;
  full_name_ = nullptr;
...
inline ::FullName* Student::unsafe_arena_release_full_name() {
  // @@protoc_insertion_point(field_release:Student.full_name)
  
  ::FullName* temp = full_name_;
  full_name_ = nullptr;
  return temp;
}
inline ::FullName* Student::_internal_mutable_full_name() {
...
inline ::FullName* Student::mutable_full_name() {
  ::FullName* _msg = _internal_mutable_full_name();
  // @@protoc_insertion_point(field_mutable:Student.full_name)
  return _msg;
}
inline void Student::set_allocated_full_name(::FullName* full_name) {
  ...
  if (full_name) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::FullName>::GetOwningArena(full_name);
  ...
  full_name_ = full_name;
  // @@protoc_insertion_point(field_set_allocated:Student.full_name)
}
...
inline int32_t Student::scores(int index) const {
  // @@protoc_insertion_point(field_get:Student.scores)
  return _internal_scores(index);
}
inline void Student::set_scores(int index, int32_t value) {
  scores_.Set(index, value);
  // @@protoc_insertion_point(field_set:Student.scores)
}
...
inline void Student::add_scores(int32_t value) {
  ...
  // @@protoc_insertion_point(field_add:Student.scores)
}
...
Student::scores() const {
  // @@protoc_insertion_point(field_list:Student.scores)
...
Student::mutable_scores() {
  // @@protoc_insertion_point(field_mutable_list:Student.scores)
...
// .Student students = 1;
inline bool StudentsGroup::_internal_has_students() const {
  return this != internal_default_instance() && students_ != nullptr;
}
inline bool StudentsGroup::has_students() const {
  return _internal_has_students();
}
inline void StudentsGroup::clear_students() {
  if (GetArenaForAllocation() == nullptr && students_ != nullptr) {
    delete students_;
  }
  students_ = nullptr;
}
inline const ::Student& StudentsGroup::_internal_students() const {
  const ::Student* p = students_;
  return p != nullptr ? *p : reinterpret_cast<const ::Student&>(
      ::_Student_default_instance_);
}
inline const ::Student& StudentsGroup::students() const {
  // @@protoc_insertion_point(field_get:StudentsGroup.students)
  return _internal_students();
}
inline void StudentsGroup::unsafe_arena_set_allocated_students(
    ::Student* students) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(students_);
  }
  students_ = students;
  if (students) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:StudentsGroup.students)
}
inline ::Student* StudentsGroup::release_students() {
  
  ::Student* temp = students_;
  students_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
...
inline ::Student* StudentsGroup::unsafe_arena_release_students() {
  // @@protoc_insertion_point(field_release:StudentsGroup.students)
  
  ::Student* temp = students_;
  students_ = nullptr;
  return temp;
}
inline ::Student* StudentsGroup::_internal_mutable_students() {
  
  if (students_ == nullptr) {
    auto* p = CreateMaybeMessage<::Student>(GetArenaForAllocation());
    students_ = p;
  }
  return students_;
}
inline ::Student* StudentsGroup::mutable_students() {
  ::Student* _msg = _internal_mutable_students();
  // @@protoc_insertion_point(field_mutable:StudentsGroup.students)
  return _msg;
}
inline void StudentsGroup::set_allocated_students(::Student* students) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete students_;
  }
  if (students) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::Student>::GetOwningArena(students);
    if (message_arena != submessage_arena) {
      students = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, students, submessage_arena);
    }
  ...
  students_ = students;
  // @@protoc_insertion_point(field_set_allocated:StudentsGroup.students)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_part2_2eproto
